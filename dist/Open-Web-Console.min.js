 ...
 */
(function(){"use strict";function _typeof(obj){"@babel/helpers - typeof";if(typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"){_typeof=function(obj){return typeof obj}}else{_typeof=function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj}}return _typeof(obj)}function _unsupportedIterableToArray(o,minLen){if(!o)return;if(typeof o==="string")return _arrayLikeToArray(o,minLen);var n=Object.prototype.toString.call(o).slice(8,-1);if(n==="Object"&&o.constructor)n=o.constructor.name;if(n==="Map"||n==="Set")return Array.from(o);if(n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))return _arrayLikeToArray(o,minLen)}function _arrayLikeToArray(arr,len){if(len==null||len>arr.length)len=arr.length;for(var i=0,arr2=new Array(len);i<len;i++)arr2[i]=arr[i];return arr2}function _createForOfIteratorHelper(o,allowArrayLike){var it=typeof Symbol!=="undefined"&&o[Symbol.iterator]||o["@@iterator"];if(!it){if(Array.isArray(o)||(it=_unsupportedIterableToArray(o))||allowArrayLike&&o&&typeof o.length==="number"){if(it)o=it;var i=0;var F=function(){};return{s:F,n:function(){if(i>=o.length)return{done:true};return{done:false,value:o[i++]}},e:function(e){throw e},f:F}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var normalCompletion=true,didErr=false,err;return{s:function(){it=it.call(o)},n:function(){var step=it.next();normalCompletion=step.done;return step},e:function(e){didErr=true;err=e},f:function(){try{if(!normalCompletion&&it.return!=null)it.return()}finally{if(didErr)throw err}}}}function _isObject(value){var type=_typeof(value);return value!=null&&(type==="object"||type==="function")}var toString=Object.prototype.toString;function getType(value){if(value==null){return value===undefined?"[object Undefined]":"[object Null]"}return toString.call(value)}function _isBoolean(value){return value===true||value===false||value!==null&&_typeof(value)==="object"&&getType(value)==="[object Boolean]"}function _isNumber(value){return typeof value==="number"||value!==null&&_typeof(value)==="object"&&getType(value)==="[object Number]"}function _isString(value){var type=_typeof(value);return type==="string"||type==="object"&&value!=null&&!Array.isArray(value)&&getType(value)==="[object String]"}function _isFunction(value){if(!_isObject(value)){return false}var type=getType(value);return type==="[object Function]"||type==="[object AsyncFunction]"||type==="[object GeneratorFunction]"||type==="[object Proxy]"}function _isPlainObject(value){if(value===null||_typeof(value)!=="object"||getType(value)!="[object Object]"){return false}if(Object.getPrototypeOf(value)===null){return true}var proto=value;while(Object.getPrototypeOf(proto)!==null){proto=Object.getPrototypeOf(proto)}return Object.getPrototypeOf(value)===proto}var domTypeHelp=function domTypeHelp(types,value){return value!==null&&_typeof(value)==="object"&&types.indexOf(value.nodeType)>-1&&!_isPlainObject(value)};
/*!
   * 💡 - 值类型判断方法
   ...
   * Released under the MIT license
   */var isObject=_isObject;var isUndefined=function isUndefined(input){return input===undefined};var isNull=function isNull(input){return input===null};var isBoolean=_isBoolean;var isNumber=_isNumber;var isString=_isString;var isFunction=_isFunction;var isArray=function isArray(input){return Array.isArray(input)};var isPlainObject=_isPlainObject;var isElement=function isElement(input){return domTypeHelp([1,9,11],input)};
/*!
   * 🌐 - 提供常用的DOM操作方法
...
/*!
   ...
   * Copyright (c) 2021-present hai2007 走一步，再走一步。
   * Released under the MIT license
   */function scssToCss(source){var blocks=analyseBlock(source);var i,j,cssCode="",preSelectorArray=[],deep=0;for(i=0;i<blocks.length;i++){if(blocks[i].type=="comment-double"){cssCode+=blocks[i].value}else if(blocks[i].type=="comment-single"){cssCode+="\n/* "+blocks[i].value+" */\n"}else if(blocks[i].type=="begin"){var preSplit=blocks[i].value.split(",");var preSelect=[];for(j=0;j<preSplit.length;j++){preSelect[j]=preSplit[j].replace(/\{$/,"").trim();if(/^&/.test(preSelect[j])){preSelect[j]=preSelect[j].replace(/^&/,"")}else{preSelect[j]=" "+preSelect[j]}}preSelectorArray[deep]=preSelect;deep+=1}else if(blocks[i].type=="end"){deep-=1}else if(blocks[i].type=="statement"){j=1;var preType=blocks[i-j].type;while(["comment-double","comment-single"].indexOf(preType)>-1){j+=1;preType=blocks[i-j].type}if(["end","begin"].indexOf(preType)>-1){cssCode+=toSelector(preSelectorArray,deep)}cssCode+="\n"+blocks[i].value+"\n";j=1;var nextType=blocks[i+j].type;while(["comment-double","comment-single"].indexOf(nextType)>-1){j+=1;nextType=blocks[i+j].type}if(["end","begin"].indexOf(nextType)>-1){cssCode+="\n}\n"}}}return cssCode}function style(){if(document.getElementById("open-web-console@style"))return;var styleElement=document.createElement("style");var head=document.head||document.getElementsByTagName("head")[0];styleElement.setAttribute("id","open-web-console@style");styleElement.innerHTML=scssToCss("\n\n    [open-web-console]{\n        overflow: auto;\n        background-color:#f3f3f4;\n        outline: 5px solid #cfcfd4;\n        border-radius: 5px;\n        user-select: none;\n        font-size:12px;\n        [isopen]{\n            position:relative;\n            &:before{\n                content: \" \";\n                display: inline-block;\n                width: 0;\n                height: 0;\n                position: absolute;\n                left: -15px;\n                top: 4px;\n            }\n        }\n        [isopen='no']{\n            &>div{\n                display:none;\n            }\n            &:before{\n                border-top: 5px solid transparent;\n                border-bottom: 5px solid transparent;\n                border-left: 10px solid #9e9e9e;\n            }\n        }\n        [isopen='yes']{\n            &:before{\n                border-left: 5px solid transparent;\n                border-right: 5px solid transparent;\n                border-top: 10px solid #9e9e9e;\n            }\n        }\n        [defType='showobject']{\n            span{\n                display:block;\n                margin-top:5px;\n            }\n            .item{\n                margin-left:20px;\n            }\n            i{\n                font-style: normal;\n                cursor: pointer;\n            }\n        }\n\n        &>.item{\n            padding:10px;\n            border-bottom: 1px solid #cfcfd4;\n            &>span{\n                display: inline-block;\n                vertical-align: top;\n                &.time{\n                    width: 80px;\n                    font-weight: 800;\n                }\n                &.msg{\n\n                }\n            }\n        }\n        .item{\n            white-space: nowrap;\n        }\n    }\n    ");styleElement.setAttribute("type","text/css");head.appendChild(styleElement)}var OpenWebConsole=function OpenWebConsole(options){if(!(this instanceof OpenWebConsole)){throw new Error("Open-Web-Console is a constructor and should be called with the `new` keyword")}style();if(isElement(options.el)){this._el=options.el;this._el.setAttribute("open-web-console","");this.log=function(msg){this.$doConsole(msg,"gray")};this.trace=function(msg){this.$doConsole(msg,"white")};this.info=function(msg){this.$doConsole(msg,"green")};this.error=function(msg){this.$doConsole(msg,"red")};this.warn=function(msg){this.$doConsole(msg,"#f1c010")};this.debug=function(msg){this.$doConsole(msg,"blue")}}else{throw new Error("options.el is not a element!")}};OpenWebConsole.prototype.$doConsole=doConsole;if((typeof module==="undefined"?"undefined":_typeof(module))==="object"&&_typeof(module.exports)==="object"){module.exports=OpenWebConsole}else{window.OpenWebConsole=OpenWebConsole}})();